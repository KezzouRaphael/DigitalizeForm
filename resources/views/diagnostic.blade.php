...
<body>
    ...
    <h2>OBJECTIF</h2>
    <p>
        Cet Outil d’Intégration Environnementale (OIE) est conçu pour structurer un dialogue, une réflexion, au niveau
        environnemental entre
        un·e agent·e économique responsable d’une activité productive soutenue par l’un de nos projets/programmes, et
        l’équipe
        technique dudit projet/programme (mais peut également être utilisé par un.e agent.e économique non-accompagné.e
        dans un
    ...
    <ol>
        <li>Dans un premier temps, un diagnostic environnemental concernant l’activité du producteur ou de la
        ...
        <li>
            Sur base de ce diagnostic, le but est de conduire à la prise d’engagements autodéterminés de la part du
        ...
        <p>Des annexes sont jointes pour faciliter l’application de l’OIE, notamment un glossaire reprenant le
        ...
        <p>Les modalités d’application de cet outil sont ouvertes. Nous laissons le soin à l’équipe technique et au
            producteur ou à la productrice, de les déterminer selon le contexte :
        </p>
        <ul>
            <li>Application conjointe entre l’équipe technique et le producteur ou la productrice (analyse au travers
                d’un dialogue) ;
            </li>
