...
<body>
    <img src="/images/Header.png" style="max-width: 100%;">
    <form method="get" action="/diagnostic">
        ...
        <hr>
        <p class="block mb-2 uppercase font-bold text-xs text-gray-700 ml-2 pt-2">En remplissant cet outil, le
        ...
        <img src="/images/footer.png" style="max-width: 100%;" />
    </form>
</body>
