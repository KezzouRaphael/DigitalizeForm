...
<body>
    ...
    <section
        ...
        <p class="py-2">Le diagnostic environnemental est réalisé au travers d’un <b>questionnaire semi-structuré</b>.
            Celui-ci est divisé
            en 4 thématiques :
        <p>
        ...
        <p class="pb-4">L’idée est de mettre en évidence les <b>connaissances et perceptions</b> du producteur ou de
            la productrice par
        ...
        <ol class="list-decimal pb-4 ml-12">
            ...
            <li><b>Une description brève des effets réciproques entre l’environnement et l’activité</b> du producteur ou
                de la
                productrice ;</li>
            <li><b>Un questionnaire semi-structuré par thématique</b> ;</li>
            <li><b>Une synthèse</b> qui reprend l’ensemble des scores, ainsi que les principales actions identifiées
                pour
                améliorer la situation environnementale de l’activité ;</li>
            <li><b>Les leçons apprises</b> permettant de mettre en évidence ce que les protagonistes retirent du
                diagnostic, et
        ...
        <ul class="list-disc ml-12">
            <li><b>Questions cibles</b> : elles ne doivent pas forcément suivre l’ordre établi et elles peuvent être
                <b>adaptées</b>
                (voire supprimées) selon le contexte ;</li>
            <li>Un <b>indicateur de pondération</b> permettant <b>d’évaluer chaque thématique</b>. Il ne s’agit pas d’un
                <b>contrôle
                    formel</b>, mais d’un bilan informatif des connaissances et capacités du producteur ou de la
                productrice.
            ...
            <li>Un <b>tableau</b> reprenant la <b>synthèse</b> des réponses aux questions, le <b>score</b> attribué pour
                la thématique, ainsi
